<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/CampManagemntMasterPage.Master"
    Inherits="System.Web.Mvc.ViewPage<com.rti.tailspinnew.Models.WcfAppService.localCampContact>" %>
            ...
            <table class="body">
              ...
              <%--  USER = 10, ADMIN = 20, SUPERADMIN = 30--%>
                ...
                <%--&nbsp;<%: Html.TextBoxFor(m => m.RoleStr, new { style = "width:450px;" })%>--%>
                 &nbsp;<%: Html.DropDownListFor(m1 => Model.Role, new SelectList(new List<Object> { new { value = 10, text = "User" }, new { value = 30, text = "Super Admin" } }, "value", "text"), new { style = "width:456px;" })%>
                ...
                <tr>
                 ...
                 &nbsp;<%: Html.DropDownListFor(m1 => Model.Role, new SelectList(new List<Object> { new { value = 302909, text = "JFG1" }, new { value = 302910, text = "JFG2" } }, "value", "text"), new { style = "width:456px;" })%>
                ...
                <tr>
                    ...
                    <td class="DatatdLeftnMiddle">
                        <p class="ButtonBar">
                            <input type="submit" value="Submit" name="UpdateCampContact"  />
