<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MasterPageWithoutLeftPane.Master" Inherits="System.Web.Mvc.ViewPage<com.rti.tailspinnew.Models.WcfAppService.localCampContact>" %>
                ...
                <tr>
                    <td class="DatatdLeftnMiddle" width="130px">
                        <div class="editor-label">
                            <asp:Label ID="lblCampContactName" runat="server" Text="Name"></asp:Label>
                        </div>
                    </td>
                    <td class="DatatdLeftnMiddle" style="padding-left: 0px">
                        <table class="body" style="width: 200px">
                            <tr>
                                ...
                                <td style="width: 50px">
                                    <%:Html.TextBoxFor(m1 => m1.MiddleName, new { style = "width:15px;" })%>
                ...
                <tr>
                    ...
                    <td class="DatatdLeftnMiddle">
                        <p class="ButtonBar">
                            ...
                            <input type="submit" value="Submit" name="SubmitMyCampContactProfile"/>
