            ...
            <table cellpadding="0px" cellspacing="0px" width="100%">
                            ...
                            <tr>
                                ...
                                <td width="35%">
                                    <table class="style1">
                                        ...
                                        <tr>
                                            <td class="Notes" align="left" colspan="2" style="padding: 16px 0px 6px 0px;">
                                                <span style="margin-top:-2px; position:absolute; font-size:9px; font-weight:normal">Department of Behavioral Health</span><br />
                                                <span style="margin-top:-2px; position:absolute; font-size:9px; font-weight:normal">and Intellectual Disability Services</span><br />
                                                <span style="margin-top:-2px; position:absolute; font-size:9px; font-weight:normal">1101 Market Street, 7th Floor</span><br />
                                                <span style="margin-top:-2px; position:absolute; font-size:9px; font-weight:normal">Philadelphia, PA  19107-2907</span><br />
                                            </td>
                                        </tr> 
                                        <tr>
                                            <td class="Notes" align="left" colspan="2" style="padding: 0px 0px 0x 0px;">
                                                <span style="margin-top:-2px; position:absolute; font-size:9px; font-weight:normal">Phone (215) 685-5400</span>
                                            </td>
                                        </tr>    
                                    </table>
                                </td>
                ...
                <tr>
                    <td class="MainHadingWithBoldAndBorder" align="center" colspan="2" style="font-size: 18px;">
                        IT IS MANDATORY FOR THIS FORM TO BE SUBMITTED BY AUGUST 15, 2013.
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="padding-bottom: 5px">
                        <table width="100%">
                            ...
                            <tr class="Fields">
                                ...
                                <td align="left" colspan="2">
                                    <asp:Label ID="Label72" Text="Reference #: " runat="server"></asp:Label>&nbsp;
                                    <%:Html.DisplayFor(m1 => m1.Reference)%>
                                </td>
                            </tr>
                            <tr class="Fields">
...
mso-border-top-alt:solid windowtext .5pt;padding:0in;mso-padding-alt:1.0pt 0in 0in 0in">
                                            ...
                                            Office of Mental Health (OMH) 1101 Market St 7<sup>th</sup> Fl. Phila., PA 19107<span 
                                                style="mso-spacerun:yes">&nbsp; </span>215-685-5400<o:p></o:p></span></p>
                                    </div>
                                    <p align="center" class="MsoFooter" style="text-align:center">
                                        <span style="font-size:9.0pt;mso-bidi-font-family:Arial;mso-bidi-font-weight:bold">
                                        Community Behavioral Health (CBH) 801 Market St. 7<sup>th</sup> Fl. Phila., PA 
                                        19107<span style="mso-spacerun:yes">&nbsp; </span>215-413-3100<o:p></o:p></span></p>
                                    <p align="center" class="MsoFooter" style="text-align:center">
                                        <span style="font-size:9.0pt;mso-bidi-font-family:Arial;mso-bidi-font-weight:bold">
                                        Office of Addiction Services (OAS) 1101 Market St 8th Fl, Phila., PA 19107<span 
                                            style="mso-spacerun:yes">&nbsp; </span>215-685-5403<o:p></o:p></span></p>
                                    <p align="center" class="MsoFooter" style="text-align:center">
                                        <span style="font-size:9.0pt;mso-bidi-font-family:Arial;mso-bidi-font-weight:bold">
                                        Intellectual disAbility Services (IDS) 701 Market St. Suite 5200 Phila., PA 
                                        19106<span style="mso-spacerun:yes">&nbsp; </span>215 685-5900<o:p></o:p></span></p>
                                </td>
                            </tr>
                            <tr class="Fields">
                                <td align="left" colspan="4">
