<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<com.rti.tailspinnew.Models.WcfAppService.localCAFListItem>>" %>
        ...
        <tr>
            <td style=" padding:10px 0px 5px 0px">
                ...
                <input type="text" id="searchtxt" name="searchtxt" style=" width:640px" />&nbsp;&nbsp;
                    <input type="submit" value="Search" id="CAFList" />
                </div>
            </td>
        </tr>
        <tr>
