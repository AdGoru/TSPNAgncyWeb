...
namespace com.rti.tailspinnew.web
{
	...
	public class CampSiteController : Controller
	{
		...
		//{
		//	return base.RedirectToAction("CampSiteAttachments", "CampSite");
		//}

		//public ActionResult CampSiteAttachments(int Id) // JHF 10/20/20
		//{
		...
		//			//WebSessionManager.AddAttachmentToCampSite((int)base.Session["usertoken"], (int)base.Session["CampSiteAppId"], fileName, str1, numArray, str[i], '); // JHF 10/20/20
		//		}
		//	}
		...
		//public ActionResult AttachDocsCampSite(int Id) // JHF Id is campsiteappid
		//{
		//	localCampSite _localCampSite = new localCampSite();
		//	if (base.Request.RequestType.ToUpper() != "POST")
		//	{
		...
		//			byte[] numArray = new byte[contentLength];
		//			inputStream.Read(numArray, 0, contentLength);
		//                  DateTime dtdocexpiry = new DateTime();
		//                  dtdocexpiry = DateTime.Now;
		//                  //WebSessionManager.AddAttachmentToCampSite((int)base.Session["usertoken"], (int)base.Session["campsiteAppId"], (int)base.Session["campcorpAppId"], fileName, str1, numArray, str[i], dtdocexpiry);
		//                  WebSessionManager.AddAttachmentToCampSite((int)base.Session["usertoken"], Id, 585, fileName, str1, numArray, str[i], dtdocexpiry); //JHF 585 for temp testing
		//              }
		//	}
		//	return base.RedirectToAction("AttachDocsCampSite", "CampSite", new { Id = Id });
		//}

		//public ViewResult CAFList()
		//{
		//	List<localCAFListItem> localCAFListItems = new List<localCAFListItem>();
		//	//localCAFListItems = WebSessionManager.getCAFListForCampSite((int)base.Session["usertoken"], (int)base.Session["campsiteAppId"]);
  ...
  //          localCampSite _localCamp3 = destination;
        ...
        public int saveCampSite(ref localCampSite model, int id)
            
        {
            return 3; // temporary JHF 12/3/19
        }
        ...
        [ActionName("AttachDocsTCAF")]
        [HttpPost]
        [LinkActionToButtonName(SubmitButtonName = "AttachCampSite")]
        public ActionResult CampSiteAttachBtn(localCampSite model, int id)
        {
            //int id;
            id = this.saveCampSite(ref model, id);
            id = 106387; // testing JHF 12/3/19
            return base.RedirectToAction("AttachDocsCampSite", "CampSite", new { Id = id }); // testing JHF 12/3/19
        }
