...
{
	public class DSMenuCheckBox : INotifyPropertyChanged, IUIelementRB_CB
	{
		...
		public DSMenuCheckBox()
		{
		}

		public DSMenuCheckBox(string groupname, string txtface, bool selection, int enumvalue, string tooltip)
		{
